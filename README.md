...
A cross-platform desktop automation application with a visual flowchart interface for creating and executing mouse and keyboard automation sequences.
