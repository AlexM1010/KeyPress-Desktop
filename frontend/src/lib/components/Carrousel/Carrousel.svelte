...
<div class="carrousel flex-[0.5] row-center">
	<button
		class="row-center font-500 p-[5px] my-[0px] m-x-[10px] cursor-pointer border-[1px] border-solid border-[var(--border)] bg-transparent rounded-[50%] hover:border-[var(--border-hover)]"
		on:click={toggleLeft}
		on:keyup
		on:keydown
		on:keypress
